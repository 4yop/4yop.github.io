  ...
  <article class="rounded-2xl bg-white p-6 shadow-sm sm:p-8">
    <section class="mb-8">
      ...
      <p class="text-sm leading-7">
        ...
        也能快速比较等额本息和等额本金两种还款方式的差异。
        页面下方还会列出前 12 期的还款明细，方便你看本金和利息是怎么变化的。
      </p>
    </section>
    ...
    <section class="mb-8">
      ...
      <div class="space-y-4 text-sm leading-7 text-gray-700">
        <p><strong>为什么工具结果和银行给的方案不完全一样？</strong> 银行审批会叠加实际利率、手续费、组合贷结构和还款规则，工具只做标准口径估算。</p>
        <p><strong>该先看月供还是总利息？</strong> 如果你更关心每月压力，先看月供；如果你在比长期成本，再看总利息和总还款额。</p>
        <p><strong>这能替代正式贷款方案吗？</strong> 不能。结果仅供预算参考，最终以银行审批和合同为准。</p>
      </div>
    </section>
