...
<article class="article-content ocr-article">
  ...
  <aside class="article-sidebar">
    <h3 class="sidebar-title">相关工具推荐</h3>
    <ul class="related-tools">
      <li><a href="/pdf-to-word">PDF转Word</a> - PDF文档格式转换</li>
      <li><a href="/image-compress">图片压缩</a> - 优化图片大小</li>
      <li><a href="/format-converter">格式转换器</a> - 多格式互转</li>
    </ul>
  </aside>
</article>
