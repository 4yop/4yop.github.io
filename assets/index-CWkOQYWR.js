import{J as k,b as _,c as d,e as t,q as C,v as T,t as b,j as y,n as M,m as r,o as i}from"./index-CkIJmO3C.js";const I={class:"max-w-3xl mx-auto p-5"},$={class:"grid grid-cols-1 md:grid-cols-2 gap-8 mb-8"},j={class:"bg-slate-50 rounded-xl p-6 shadow-md"},z={class:"text-right text-xs text-slate-500 mt-2.5"},B={class:"bg-slate-50 rounded-xl p-6 shadow-md"},V={class:"bg-white rounded-lg p-8 mb-5 text-center min-h-32 flex items-center justify-center shadow-sm"},D={key:0,class:"text-center"},q={class:"text-2xl font-bold text-blue-500 mb-2"},E={class:"text-sm text-slate-500"},J={key:1,class:"text-slate-500"},N={class:"flex gap-2.5 justify-center flex-wrap"},P=["disabled"],R={class:"bg-white rounded-xl p-6 shadow-md"},S={class:"flex gap-2.5 flex-wrap justify-center"},F=k({__name:"index",setup(U){const u=r(""),o=r([]),n=r(""),c=r(-1),x=r(!1),m=r(""),v=r("success"),g={yesno:`是
否`,dice:`1
2
3
4
