import{B as V,o as I,a as p,c as f,b as t,s as i,t as k,u as a,E as B,j as M,r as m,z as y,d,M as b,i as $}from"./index-Cdij7XGu.js";const T={class:"random-picker-container"},w={class:"picker-section"},E={class:"input-panel"},N={class:"item-count"},j={class:"result-panel"},D={class:"result-display"},P={key:0,class:"selected-item"},R={class:"item-text"},S={class:"item-index"},U={key:1,class:"no-selection"},q={class:"action-buttons"},A={class:"templates-section"},F={class:"template-buttons"},G=V({__name:"index",setup(H){const v=m(""),n=m([]),l=m(""),c=m(-1),x={yesno:`是
否`,dice:`1
2
3
4
