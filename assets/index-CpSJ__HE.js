...
`)}catch{b("格式化失败","error")}}function C(){s.value==="md2html"?d.value=`# Markdown示例文档
  ...
  </html>`,L()}function P(){d.value="",a.value="",i.value=""}async function R(){if(!a.value){b("没有可复制的内容","warning");return}try{const{ClipboardUtil:o}=await x(async()=>{const{ClipboardUtil:t}=await import("./ClipboardUtil-DJXy2Bl2.js");return{ClipboardUtil:t}},[]);await o.copyText(a.value)?b("结果已复制到剪贴板","success"):b("复制失败","error")}catch(o){b("复制失败: "+o.message,"error")}}async function I(){if(!a.value){b("没有可下载的内容","warning");return}const o=s.value==="md2html"?"html":"md",l=await x(()=>import("./DownloadUtil-CjDOAHRx.js"),__vite__mapDeps([0,1,2,3])),t=l.generateTimestampFilename("converted",o);l.downloadText(a.value,t),b("文件下载成功","success")}function H(o){return o?o.split(`
