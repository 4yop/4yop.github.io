const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DEKQtSOw.js","assets/index-BI5eHBmo.js","assets/index-BBIRZ090.css"])))=>i.map(i=>d[i]);
import{K as se,e as re,i as ne,c as m,b as o,n as ae,t as C,j as B,q as I,C as U,l as le,m as f,f as V,o as v}from"./index-BI5eHBmo.js";const ie={class:"min-h-screen flex flex-col bg-gray-100 text-gray-800"},ce={class:"flex-1 px-4 py-6 max-w-2xl mx-auto w-full"},de={class:"mb-8"},ue={key:0,class:"bg-white border border-gray-200 rounded-md p-4 mb-6"},fe={class:"flex items-center justify-between"},pe={class:"font-medium flex-1 truncate"},ge={class:"text-gray-600 mx-4"},be={key:1,class:"bg-white border border-gray-200 rounded-md p-6 mb-6"},me={class:"mb-6"},ve={class:"flex items-center mb-3"},xe={class:"flex items-center"},he=["disabled"],ye={key:0},we={key:1,class:"inline-block animate-pulse"},_e={key:2,class:"bg-white border border-gray-200 rounded-md p-6 mb-6"},ke={class:"h-2 bg-gray-200 rounded-full overflow-hidden mb-3"},De={class:"text-center text-gray-600"},Ce={key:3,class:"mb-6"},Be={class:"bg-white border border-gray-200 rounded-md p-8 text-center"},Fe={class:"text-gray-600 mb-6"},Pe={key:4,class:"mb-6"},Me={class:"bg-white border border-gray-200 rounded-md p-8 text-center"},ze={class:"text-red-600 mb-6"},We=se({__name:"index",setup(Se){const S=f(null),p=f(null),y=f(!1),d=f(0),x=f(null),w=f(""),F=f(!1),L=f(!0),P=f(!0),_=f(null);function X(){S.value.click()}function $(t){const e=t.target.files[0];j(e)}function H(t){t.preventDefault(),F.value=!0}function K(t){t.preventDefault(),F.value=!1}function N(t){t.preventDefault(),F.value=!1;const e=t.dataTransfer.files[0];j(e)}function j(t){if(!t)return;if(!t.name.endsWith(".docx")){w.value="请选择 .docx 格式的文件";return}const e=50*1024*1024;if(t.size>e){w.value="文件大小不能超过 50MB";return}W(),x.value=null,p.value=t,d.value=0}function q(){p.value=null,x.value=null,d.value=0,S.value.value=""}function W(){w.value=""}function A(t){if(t===0)return"0 Bytes";const e=1024,r=["Bytes","KB","MB","GB"],s=Math.floor(Math.log(t)/Math.log(e));return parseFloat((t/Math.pow(e,s)).toFixed(2))+" "+r[s]}function G(){if(typeof Worker>"u"){console.warn("浏览器不支持 Web Worker"),P.value=!1;return}const t=`
