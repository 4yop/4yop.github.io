...
const WM = {
  ...
  openWindow(opts) {
    ...
    const w = clamp(opts.w || 640, opts.minW || 200, u.w - 20);
    const h = clamp(opts.h || 440, opts.minH || 120, u.h - 10);
    ...
    const win = {
      ...
      minW: opts.minW || 200, minH: opts.minH || 120,
